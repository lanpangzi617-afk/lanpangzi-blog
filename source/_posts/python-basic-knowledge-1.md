...
**__init___(self)**：python 类的初始化方法，用来初始化对象的属性，不返回实例。
...
![](C:\Users\Lenovo\AppData\Roaming\marktext\images\2026-01-09-18-48-19-image.png)__
...
包（package)：一个文件夹内用于存放相关的模块，在该文件夹中必须创建一个"__init__.py"的模块文件，内容可谓空
